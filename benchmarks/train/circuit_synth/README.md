...
Minimal-circuit synthesis as DQBF, two variants:

- `gates/` — minimum gate count
- `depth/` — minimum depth (gates in `d` layers of fixed width)
...
`depth/` is the depth-constrained dual. A QBF
