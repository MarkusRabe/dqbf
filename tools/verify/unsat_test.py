...
def test_sfex_refutation() -> None:
    ...
    p = _proof(
        ...
        {"clause": (-5,), "rule": "axiom"},
        {"clause": (-6,), "rule": "axiom"},
        {"clause": (2, 4, 7), "rule": "sfex", "premises": (0,), "part": (4,), "c3": (2,), "fresh": 7},
        {"clause": (-7, 2, 5, 6), "rule": "sfex", "premises": (0,), "part": (4,), "c3": (2,), "fresh": 7},
...
def test_sfex_dep_subtraction_used_downstream() -> None:
    ...
    p = _proof(
        ...
        {"clause": (-5, 1, 4), "rule": "sfex", "premises": (0,), "part": (3,), "c3": (1,), "fresh": 5},
